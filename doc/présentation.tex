...
L'estimation du MFE d'une séquence d'ADN se complexifie en fonction de sa longeur. Cependant, les méthodes thermodynamiques comme celle de NUPACK sont rapides et relativement précises.
...
\begin{figure} \label{fig:MFE_exp_simul}
    \caption{Corrélation MFEs simulés et empiriques} \center
